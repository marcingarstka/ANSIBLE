<#
.EXAMPLE
.\AddADComputerAccount_windows.ps1 -CompHost SERVER01 -OU "APPS,ou=SERVERS,dc=lab,dc=local" -Role "NGINX Machine" 
...
$var02 = $Role
$var03 = "cn=WINDOWS_ADMIN_$CompHost,ou=Security Groups,dc=lab,dc=local"
$var04 = "Administrative access to Windows machine - $CompHost"
